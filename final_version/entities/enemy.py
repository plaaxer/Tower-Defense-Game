...
class Enemy(pg.sprite.Sprite):
    ...
    def move(self, ControladorLevel):
        ...
        if dist >= (self.speed*self.base_speed*ControladorLevel.velocidade_jogo):
            self.pos += self.movement.normalize() * (self.speed*self.base_speed*ControladorLevel.velocidade_jogo)
        else:
            if dist != 0:
